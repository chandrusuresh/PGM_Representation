...
for i = 1:length(alphaList)
    ind1 = find(assignments(:,2) == i & assignments(:,1) == 1);
    ind2 = find(assignments(:,2) == i & assignments(:,1) == 2);
    phenotypeFactor.val(ind1) = alphaList(i);
    phenotypeFactor.val(ind2) = 1 - alphaList(i);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%